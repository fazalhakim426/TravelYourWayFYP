                    ...
                    <!-- /Stats Row Ends Here -->
                                 ...
                                 <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                                      ...
                                      <tr>
                                        ...
                                        <th class="border w-1/8 px-4 py-2">No Member</th>
                                        <th class="border w-1/8 px-4 py-2">Type</th>
                                        <th class="border w-1/8 px-4 py-2">Route</th>
...
<tr>
                                        ...
                                        <td class="border px-1 p-2"></td>
                                      {{-- <td class="border px-4 py-2">
                                     {{$visa->number_of_people}}
                                     </td> --}}
                                        ...
                                        {{ $visa->type=="Hajj"|| $visa->type=="Ummrah"?"":$visa->visa_apply_country}}<br>{{$visa->type}}</td>
                                         <td class="border">
                                           Visa To: {{$visa->visa_apply_country}}

                                         </td>
                                        <td class="border px-4 py-2"><br>from: {{$visa->street}}<br>{{$visa->phone_number}}<br>{{$visa->work_phone}}</td>
