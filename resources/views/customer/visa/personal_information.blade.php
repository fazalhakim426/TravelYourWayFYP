...
@include('customer.layout.navigation')
  ...
  <li class="-mb-px mr-1 ">
       <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-dark font-semibold" href="/personalInformationIndex">Personal Information</a>
    
  </li>

  <li class="mr-1 ">
    <!-- <a class="bg-white inline-block py-2 px-4 text-grey-light font-semibold" href="#">Tab</a> -->
    <a class="bg-white inline-block py-2 px-4 text-grey-light font-semibold" href="#">Contact Information</a>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                            ...
                                            <input name="first_name"  value="{{old('first_name')==null?($visa->first_name=null?"Pakistan":"Pakistan"):old('first_name')}}"  class="appearance-none block w-full bg-gray-200 @error('first_name')  border-red-500 @enderror text-grey-darker border border-gray-200 rounded py-3 px-4 leading-tight border-yellow-500   leading-tight focus:outline-none focus:bg-white-500 focus:bg-white-500 focus:border-gray-600"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                            ...
                                            <input name='date_of_birth'  value="{{old('date_of_birth')==null?$visa->date_of_birth:old('date_of_birth')}}"  class="appearance-none  @error('date_of_birth')  border-red-500 @enderror block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight border-yellow-500   leading-tight focus:outline-none focus:bg-white-500 focus:bg-white focus:border-grey"
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                            <label class="block uppercase tracking-wide text-gray-700  mb-1"
                                                ...
                                                <select name="gender"   class="appearance-none  @error('gender')  border-red-500 @enderror block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight border-yellow-500   leading-tight focus:outline-none focus:bg-white-500 focus:bg-white focus:border-grey"
