...
@include('userdashboard.layout.navigation')
  ...
  <li class="-mb-px mr-1 ">
       <a class="bg-white inline-block py-2 px-4 text-blue hover:text-blue-darker font-semibold" href="/creat1">Personal Information</a>
  ...
  <li class="mr-1">
    <a class="bg-white inline-block py-2 px-4 text-blue hover:text-blue-darker font-semibold" href="/create4">Passport Information</a>
    </li>
   </li>

      <li class="mr-1">
      <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-dark font-semibold" href="#">Education Detail</a>
      </li>
</div>
</ul>
                            </div>
                            ...
                            <form class="w-full" action='{{route("store5")}}' method='post'>
                            @csrf
