...
<body>
      ...
      <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-dark font-semibold" href="#">Trip Details</a>
      </li>

  <li class="-mb-px mr-1 ">
       <a class="bg-white inline-block py-2 px-4 text-grey-light font-semibold" href="#">Personal Information</a>
...
<form method="POST"   action="{{ route('visas.store') }}">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                            ...
                                            <input name='arrival_airport' value="{{ old('arrival_airport') }}" id="arrival_airport"  class=" appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-200 rounded py-3 px-4 border-yellow-500   leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                                                    type="text" placeholder="Arrival Airport">
                                    ...
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            ...
                                            <div class="relative">
                                                <select name='departure_airport' class="border-yellow-500 block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                                        id="grid-state">
                                                        @if(old('departure_airport'))
                                                        <option>{{ old('departure_airport')}}</option>
                                                        @endif
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                        ...
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 " id='numberofpeople'>
                                            ...
                                            <input name='days' 
                                             class="appearance-none @error('days') border-red-500 @enderror block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 border-yellow-500   leading-tight focus:outline-none focus:bg-white-500"
                                                   id="days" value="{{  old('days')==null?$visa->days:old('days') }}"
                                                   type="number" placeholder="Days">
