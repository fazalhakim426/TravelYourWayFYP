            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                ...
                <div class="flex flex-col">
                    ...
                    <!-- </div> -->
                                    ...
                                    <tbody>
                                    <tr>
                                            <td class="border px-4 py-2">Dubai</td>
                                            <td class="border px-4 py-2"> 900 PKR</td>
                                            <td class="border px-4 py-2">
                                            <button class="bg-red-500 hover:bg-red-800 text-white font-light py-1 px-2 rounded-full">
                                                Disable
                                            </button>
                                        ...
                                        <tr>
                                            <td class="border px-4 py-2">America</td>
                                        ...
                                        <tr>
                                            <td class="border px-4 py-2">Saudi Arab</td>
