...
@include('userdashboard.layout.navigation')
  ...
  <li class="mr-1">
    <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-dark font-semibold" href="#">Family Background</a>
  ...
  <li class="mr-1">
    <a class="bg-white inline-block py-2 px-4 text-grey-light font-semibold" href="#">Passport Information</a>
      ...
      <a class="bg-white inline-block py-2 px-4 text-grey-light font-semibold" href="#">Education Detail</a>
                            ...
                            <form method='post' action="{{route('store3')}}" class="w-full">
                            @csrf   
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        ...
                                        <div class="w-full md:w-1/2 px-3">
                                            ...
                                            <input name="language" value="{{old('language')==null?$visa->language:old('language')}}" class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-200 rounded border-yellow-500  py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                                                   id="grid-last-name" type="text" placeholder="Pushto">
                                                   @error('language')
                                            <p class="text-red-500 text-xs italic">{{$message}}</p>
                                                     @enderror
                                        </div>
