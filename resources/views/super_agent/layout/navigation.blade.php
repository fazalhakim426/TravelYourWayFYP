        ...
        <div class="flex flex-1">
            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                ...
                <ul class="list-reset flex flex-col">
                    <li class=" w-full h-full py-3 px-2 border-b border-light-border @if(Request::url() === URL::to('/').'/superagentdashboard') bg-white @endif">
                    
                        <a href="/superagentdashboard"  class="font-sans hover:font-normal text-sm text-nav-item no-underline">
                    ...
                    <li class="w-full h-full py-3 px-2">
                        ...
                        <li class="border-t mt-2 border-light-border w-full h-full px-2 py-3  @if(Request::url() === URL::to('/').'/ticketrequests') bg-white @endif">
                                <a  href="/ticketrequests"
                            ...
                            <li class="border-t mt-2 border-light-border w-full h-full px-2 py-3 @if((Request::url() === URL::to('/').'/mangaeagents')) bg-white @endif @if((Request::url() === URL::to('/').'/manageadminvisaedit0')) bg-white @endif  @if((Request::url() === URL::to('/').'/manage/adminvisaedit1')) bg-white @endif  @if((Request::url() === URL::to('/').'/manage/adminvisaedit2')) bg-white @endif  @if((Request::url() === URL::to('/').'/manage/adminvisaedit3')) bg-white @endif  @if((Request::url() === URL::to('/').'/manage/adminvisaedit4')) bg-white @endif  @if((Request::url() === URL::to('/').'/manage/adminvisaedit5')) bg-white @endif ">
                                <a   href="/mangaeagents"
                                   class="mx-4 font-sans hover:font-normal text-sm text-nav-item no-underline">
                                     Agent request
                                    <span><i class="fa fa-angle-right float-right"></i></span>
